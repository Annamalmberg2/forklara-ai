  ...
  "kort": [
    {
      ...
      "anteckningar": "Jag är legitimerad gymnasielärare matematik och fysik → Numer VD och driver AiNNOVA.\n\nAI = Anna Intelligens. \n\nSkratta först, efter föreläsningen kommer du också att vilja veta allt jag vet om AI. Lyssna noga och ta tillvara på vår tid och gå tillabaka till länkar och material.\n\nVad är egentligen AI?",
      "begrepp": [
        "AiNNOVA"
      ],
      "alias": [
