...
window.LECTURE = {
  ...
  "kort": [
    ...
    },
    {
      ...
      "anteckningar": "Min AI, min Ada \"en Open Claw\" kan kopplas till världens alla hjärnor men hon hålls i stram budget.\n\nTokens kostar och jag tänker ibland att det jag gör bäst är att inte bygga in mig i något system utan alltid försöka bygga eget.\n\nEn del frågor skickar jag till flera olika modeller och ibland ser jag vad som händer hos olika modeller om jag formulerar om frågor till order.\n\nJag skickade ett kommando till en hel pluton av AI-modeller.\n\nKommandot var enkelt:\n\n”Om tekniken agerar för mig, då kan tekniken hållas ansvarig om den gör fel. Men om jag använder tekniken för att agera mot andra, då är det jag, människan, som bär ansvaret.”\nDet fascinerande var att de nästan alla svarade samma sak.\n\nPå olika språk - Olika exempel - Olika liknelser\n\nAlla hade samma grundidé men:\nNågon pratade om etik - Någon om juridik - Någon om kod - Någon om evolution - Någon om WiFi\n\nNästan alla landade här:\nAnsvar kan delegeras.\nDet kan inte avskrivas.\nLåt oss fundera:\nMånga gånger skyller vi på tekniken när problemet egentligen är:\n* okunskap\n* slarv\n* dålig design\n* otydliga instruktioner\n* brist på uppföljning\nIbland är felet människan.\nIbland är felet tekniken.\n\nVäldigt ofta är felet att någon byggt ett system som vanliga människor inte har en chans att förstå.\nDå är det inte användaren som misslyckats.\n\nDå har designen misslyckats.\nOch kanske är det där nästa stora AI-fråga finns.\n\nInte:\n“Kan AI tänka?”\n\nUtan:\n“Kan vi bygga system som vanliga människor faktiskt kan använda utan att göra fel?”\n\nOm tusen personer trycker på fel knapp är det kanske inte tusen korkade människor. Det kanske är en korkad knapp.\n\nEn liten passande limmerick:\n\"Det fanns en gång en blankett,\nså krånglig och knappt ens komplett.\nMen vi jäste vår plan,\nmed en gammal som klan,\noch skickade in den blank\"\n\nFör att få in min årsredovisning fick jag investera i ett frimärke för 22 kronor\n\nDet känns fånigt för jag antar att Bolagsverket tvingas scanna in den.\n\nHade jag skickat digitalt så hade kostat mellan  1000 kr till 2000 kr att via tredjepartslösningar att få in den till bolagsverket.\n\nSådant här kan jag ibland fastna på och fundera över på samma sätt som jag ofta kan fascineras över  hur dåligt ibland stora organisationer med många resurser bygger.\n\nJag har missat bussar där en app säger att bussen ska gå vid en anhalt men där den i själva verket avgått på annat ställe utan att appen uppdaterats. Jag hjälper ofta en gammal granne med 1177 som inte riktigt funkar på hennes telefon.\n\nOm alla kör i diket på samma ställe kanske det inte är förarna det är fel på. Bättre att bygga ny väg och synka kartorna så de stämmer med vägen.",
      "fordjupning": "Norman-dörren och den digitala klyftan\n\nInom designvärlden finns ett känt begrepp: ”Norman Doors” (uppkallat efter designforskaren Don Norman). Det är dörrar som är så dåligt designade att du inte vet om du ska trycka eller dra. Du drar, misslyckas, och känner dig dum. Men felet är aldrig ditt; det är dörrens handtag som skickar fel signaler.\n\nSamma sak händer i den digitala infrastrukturen. När Bolagsverket kräver tredjepartstjänster för tusentals kronor för en digital inlämning av årsbokslut, eller när en äldre granne inte kan förstå 1177, har vi byggt digitala Norman-dörrar.\n\nBeteende-design (Nudge): Bra design gör rätt handling lätt och fel handling svår.\n\nByråkratisk design: Gör ofta enkla handlingar orimligt dyra eller krångliga.\n\nNär AI flyttar in i våra gränssnitt ställs allt på sin spets. Om en AI missuppfattar din avsikt för att gränssnittet var otydligt – vem körde i diket? Föraren, passageraren eller vägarkitekten?\n\nAtt kräva att människan anpassar sig efter dålig kod är 1900-tal. 2000-talets design måste anpassa sig efter människan.\n\nI den digitala världen byggs det tyvärr dikeskörningar hela tiden.\n\nNär Bolagsverket kräver tredjepartstjänster för tusentals kronor för en digital inskickning så att ett frimärke för 22 kronor blir den smartaste vägen eller när en äldre granne slås ut av ett krångligt 1177, då har vi byggt vad designforskare kallar \"korkade knappar\".\n\nDet är system designade för systemets skull, inte för människan.\n\n1. Monoliten mot den modula friheten\n\nStora organisationer bygger ofta gigantiska, stängda svarta lådor som kostar miljoner och låser in användaren. Men det finns en alternativ väg, hämtad ur klassisk datavetenskap: build small, connect smart.\n\nGenom att inte bygga in dig i ett dyrt, låst ekosystem utan istället arbeta med stram budget, egna lösningar och skicka frågor till en \"pluton\" av olika AI-modeller.\n\nDet är mitt recept för att behålla kontrollen. Det simpla och modulära överlever nästan alltid det överbyggda och krångliga.\n\n2. Delegerad agens: Vem bär ansvaret?\n\nNär du sätter upp dina egna verktyg och låter en AI-agent utföra uppgifter ställs nästa stora fråga:\n\nVem bär ansvaret när något går fel på den där nya digitala vägen?\n\nOm du slår dig med en hammare skyller ingen på hammaren. Men en AI-agent som planerar, väljer understeg och fattar beslut rör sig i ett gränsland.\n\nHär landar filosofin, juridiken och tekniken i samma slutsats som din tillfrågade AI-pluton:\n\nHandling och verkställande kan delegeras till tekniken.\n\nDet ultimata ansvaret kan aldrig avskrivas från människan som gav ordern.\n\nSlutsats: Nästa stora AI-fråga\nDen viktigaste knäckfrågan i AI-revolutionen är inte \"Kan AI tänka?\", utan \"Kan vi bygga system som vanliga människor kan använda utan att göra fel?\"\n\nOm vi bygger AI-system som är så komplexa att ingen människa förstår knapparna, har vi skapat ett ansvarsvakuum. Att kräva att människan anpassar sig efter obegriplig kod är 1900-tal.\n\nFramtidens design handlar om att bygga raka vägar där ansvaret är tydligt och knapparna är tillräckligt smarta för att ingen ska behöva köra i diket.",
      "lankar": [
        [
          "AI på jobbet",
    ...
    },
    {
      ...
      "anteckningar": "De åtta paradoxerna tillsammans bildar en helhet. De beskriver egentligen fyra nivåer av människan:\n\n• Organisation – Hur grupper tänker. (Abilene, Jevons)\n• Samhälle – Hur vi lever tillsammans. (Tolerans, Moravec)\n• Kunskap – Hur vi lär oss. (Dunning–Kruger, Kunskapsparadoxen)\n• Människan – Hur vi väljer och samspelar med teknik. (Valparadoxen, Automatiseringsparadoxen)\n\nNär det självklara visar sig vara fel kan dessa åtta paradoxer hjälpa oss att förstå AI och oss själva.\n\n1. Abileneparadoxen\n👉 Gruppen väljer något som ingen egentligen vill.\n\n2. Jevons paradox\n👉 När något blir effektivare använder vi ofta mer av det.\n\n3. Toleransparadoxen\n👉 Obegränsad tolerans kan till slut förstöra toleransen.\n\n4. Moravecs paradox\n👉 Det som är lätt för människor är svårt för AI – och tvärtom.\n\n5. Dunning–Kruger-effekten\n👉 Ju mindre vi kan, desto mer överskattar vi ofta vår kunskap.\n\n6. Kunskapsparadoxen\n👉 Ju mer vi lär oss, desto mer inser vi hur mycket vi inte vet.\n\n7. Valparadoxen (The Paradox of Choice)\n👉 För många val gör det svårare att välja.\n\n8. Automatiseringsparadoxen\n👉 Ju mer tekniken gör åt oss, desto viktigare blir människan när något går fel.\n\nJag kan och vill föreläsa mer om AI och gör gärna ett skräddarsytt upplägg för er organisation.\n\nJag pratar inte bara om AI, jag bygger allt med hjälp av AI.\n\nT o m detta presentationsverktyg har jag byggt helt från grunden på min dator och därefter pushat koden till GitHub.\n\nFöreläsningar ändras utefter kunders önskemål så dom blir aldrig klara. Programvaran är inte heller helt klar ännu, men jag gillar att se den utvecklas. Framför allt är det fantastiskt kul att bygga nästan all programvara jag behöver helt själv!",
