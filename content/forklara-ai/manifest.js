// ============================================================
// FÖRKLARA AI — innehållsfil (sparad från redigeringsläget 2026-07-22 23:57:28)
  ...
  "kort": [
    {
      ...
      "anteckningar": "Jag är legitimerad gymnasielärare matematik och fysik → Numer VD och driver AiNNOVA.\n\nAI = Anna Intelligens. \n\nSkratta först, efter föreläsningen kommer du också att vilja veta allt jag vet om AI. Lyssna noga och ta tillvara på vår tid och gå tillabaka till länkar och fördjupningsmaterial.\n\nVad är egentligen AI?",
      "begrepp": [
        "AiNNOVA"
      ],
      "alias": [
    ...
    },
    {
      "id": "010-60",
      "sektion": "010",
      "titel": "Hur snabbt går det egentligen?",
      "svar": "Exponentiellt. Trettio steg och du är förbi månen. Vår intuition är linjär.",
      "bilder": [
    ...
    },
    {
      ...
      "svar": "Ada Lovelace, 1843 — världens första program, till en maskin som inte fanns än.",
      "bilder": [
    ...
    },
    {
      ...
      "svar": "I Biblioteket — verktyg, poddar, böcker, personer och mycket som jag byggt. Klicka Biblioteket i menyn. PS! Glöm inte att min kunskap om AI är långt mycket större så har du en fråga så vet du vem du ska fråga.",
      "bilder": [
        "Biblioteket.png"
      ],
