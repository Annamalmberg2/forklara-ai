...
window.LECTURE = {
  ...
  "kort": [
    ...
    },
    {
      ...
      "fordjupning": "<p class=\"ingress\">AI är en fena på mönster — och var länge blind för sanning. Skillnaden mellan de två är hela skillnaden mellan en gissning och ett bevis. Det var här min egen granskning av AI började, och det är fortfarande det första jag testar.</p>\n\n<div class=\"section\">\n  <div class=\"section-head\"><span class=\"num\">1</span><span class=\"concept\">Primtalet som lurar</span><span class=\"tag\">Mönster mot bevis</span></div>\n  <div class=\"body\">Skjut in en trea i taget: 31, 331, 3331, 33331 … De åtta första talen är alla primtal. Det nionde, <strong>333 333 331</strong>, ser precis likadant ut — men är 17 × 19 607 843.<br><br>Så ser AI:s misstag ofta ut: <strong>mönstret håller precis länge nog för att vi ska sluta kontrollera.</strong></div>\n  <div class=\"lost\"><div class=\"lost-label\">Nörddetalj värd att ha</div><div class=\"lost-text\">Att pröva delbarhet med små primtal (7, 11, 13, 17 …) avslöjar bluffen snabbt — redan 17 fäller talet. Det som ser oövervinnerligt ut faller ofta för det enklaste verktyget i lådan.</div></div>\n</div>\n\n<div class=\"section\">\n  <div class=\"section-head\"><span class=\"num\">2</span><span class=\"concept\">Så ser en hallucination ut</span><span class=\"tag\">Hallucination</span></div>\n  <div class=\"body\">När en modell inte vet fyller den luckan med något <em>sannolikt</em> — med samma säkra ton som när den har rätt. Det kallas hallucination. Det är inte lögn; det är mönsterfyllnad utan förståelse.<br><br>Ett snabbt primtalstest (som Miller–Rabin) svarar \"troligen primtal\" med hög säkerhet. Men <strong>\"troligen\" är inte \"bevisat\"</strong>.</div>\n  <div class=\"why\"><div class=\"why-label\">Kärnan i det hela</div><div class=\"why-text\">Skillnaden mellan statistik och bevis är exakt skillnaden mellan en språkmodells gissning och matematikens sanning. Mönster är vackra. Bevis är sanning.</div></div>\n</div>\n\n<div class=\"section\">\n  <div class=\"section-head\"><span class=\"num\">3</span><span class=\"concept\">Idag kan de flesta räkna — men lärdomen står kvar</span><span class=\"tag\">Verifiering</span></div>\n  <div class=\"body\">Ärlighetens skull: de tidiga modellerna sa \"troligen primtal\". <strong>Idag kan de flesta räkna rätt</strong> — men ofta för att de i tysthet kör riktig kod bakom kulisserna, inte för att de \"tänker matematik\". Jag har till och med spelat schack mot en bildmodell.<br><br>Verktygen blir bättre. Vanan att kontrollera bör inte försvinna med dem.</div>\n  <div class=\"insight\"><div class=\"insight-label\">Så började det för mig</div><div class=\"insight-text\">Mitt första möte med ChatGPT var i november 2022, mitt i obalansen efter en borreliainfektion. AI hjälpte mig hitta min styrka: att ifrågasätta, nyfiket undersöka, stå på mig, söka mönster — och alltid kräva beviset.</div></div>\n</div>",
    ...
    },
    {
      ...
      "fordjupning": "<p class=\"ingress\">Ja. En modell lär sig av det vi gjort — inklusive det vi borde ha slutat med. Den goda nyheten: till skillnad från oss människor har AI ingen prestige, och bias går faktiskt att mäta och delvis träna bort. Den dåliga: bara om vi vet vad vi ska leta efter.</p>\n\n<div class=\"section\">\n  <div class=\"section-head\"><span class=\"num\">1</span><span class=\"concept\">Den lär av det vi gjort</span><span class=\"tag\">Bias</span></div>\n  <div class=\"body\">En modell blir bara så rättvis som datan den tränats på. Ligger våra historiska skevheter i datan, ärver och förstärker modellen dem — med samma övertygande yta som primtalen.</div>\n  <div class=\"lost\"><div class=\"lost-label\">Här brukar folk tappa det</div><div class=\"lost-text\">Bias syns sällan i ett enskilt svar. Den syns i <strong>statistiken över tusen</strong>. Ett enskilt svar kan vara helt rimligt medan mönstret över många är snedvridet. Därför lurar den — precis som ett prov som ser rätt ut men bygger på fel facit.</div></div>\n</div>\n\n<div class=\"section\">\n  <div class=\"section-head\"><span class=\"num\">2</span><span class=\"concept\">Två exempel som blev läroböcker</span><span class=\"tag\">Konkret</span></div>\n  <div class=\"body\"><strong>Amazons rekryteringsverktyg</strong> (skrotat 2018) lärde sig av tio års anställningar — mest män — och började därför sortera bort ansökningar som nämnde \"kvinnor\". Mönstret var korrekt inlärt och djupt fel.<br><br><strong>Ansiktsigenkänning:</strong> forskningsprojektet <em>Gender Shades</em> (Buolamwini och Gebru, 2018) visade att flera kommersiella system hade nära perfekt träff på ljushyade män men stora fel på mörkhyade kvinnor. Samma teknik, vitt skilda villkor beroende på vem du är.</div>\n</div>\n\n<div class=\"section\">\n  <div class=\"section-head\"><span class=\"num\">3</span><span class=\"concept\">Två frågor att alltid ställa</span><span class=\"tag\">Granska datan</span></div>\n  <div class=\"body\">Innan du litar på en modell, fråga:<br><br><strong>1. Vad tränades den på?</strong><br><strong>2. Vem finns inte i datan?</strong><br><br>De flesta stora modeller är tränade mest på engelska och ser världen genom engelska ögon. Mina egna modeller är mest tränade på felstavad värmländska — och får lära sig se världen genom mina.</div>\n  <div class=\"why\"><div class=\"why-label\">Går bias att träna bort?</div><div class=\"why-text\">Delvis. Med bredare data, mänsklig återkoppling (RLHF) och medvetna spärrar kan man mäta och minska skevheten — något som är mycket svårare hos en människa som försvarar sin. Men helt bort? Nej. Det är ett aktivt, olöst forskningsproblem. <strong>Hedvig behövs, men Hedvig måste också granskas.</strong></div></div>\n</div>",
