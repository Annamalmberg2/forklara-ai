...
window.LECTURE = {
  ...
  "kort": [
    ...
    },
    {
      ...
      "fordjupning": "<p class=\"ingress\">Var detektiv. En övertygande lögn har aldrig varit billigare att tillverka — men det betyder inte att sanningen är förlorad. Det betyder att bevisbördan flyttat: från att <em>se</em> till att <em>kontrollera</em>.</p>\n\n<div class=\"section\">\n  <div class=\"section-head\"><span class=\"num\">1</span><span class=\"concept\">Bevisbördan flyttar</span><span class=\"tag\">Deepfakes</span></div>\n  <div class=\"body\">En röst kan klonas ur några sekunder ljud. Ett ansikte läggas på en främmande kropp. En \"nyhet\" skrivas i tusental på en eftermiddag. Det som förr krävde en studio gör vem som helst nu på en telefon.<br><br>Fråga därför inte \"ser det äkta ut?\" — det gör det alltid. Fråga: <strong>var kommer det ifrån, vem tjänar på att jag tror det, och kan jag nå källan en annan väg?</strong></div>\n  <div class=\"insight\"><div class=\"insight-label\">Husregeln hemma</div><div class=\"insight-text\">Ring numret du redan har, inte det du fick. Och bestäm ett <strong>kodord i familjen</strong> — en enkel fråga bara ni kan svaret på. Det slår all teknik.</div></div>\n</div>\n\n<div class=\"section\">\n  <div class=\"section-head\"><span class=\"num\">2</span><span class=\"concept\">Tekniken är inte ny — spridningen är det</span><span class=\"tag\">Historik</span></div>\n  <div class=\"body\">Deepfakes fanns långt före dagens verktyg. Redan 2018 gjorde BuzzFeed en berömd deepfake där Jordan Peele talade som Obama; 2020 gjorde MIT en av Nixon (\"In Event of Moon Disaster\"). Då tog det tid och kostade mycket.<br><br>Det nya är att <strong>vem som helst kan göra det nu</strong>, billigt och utan kodkunskap. Tekniken hade varit farligare om bara några få behärskat den — nu har vi alla fått den, på gott och ont.</div>\n  <div class=\"lost\"><div class=\"lost-label\">Baksidan folk missar</div><div class=\"lost-text\">När allt kan vara fejk kan också det <em>äkta</em> avfärdas som fejk. Forskare kallar det \"lögnarens utdelning\" — den skyldige säger bara \"det där är en deepfake\". Att kunna lita på något blir en bristvara.</div></div>\n</div>\n\n<div class=\"section\">\n  <div class=\"section-head\"><span class=\"num\">3</span><span class=\"concept\">Kommer sanningen tillbaka?</span><span class=\"tag\">Forskningsfront</span></div>\n  <div class=\"body\">Ett svar som växer fram är <strong>härkomst</strong> (provenance): att märka äkta bilder och filmer med en sorts osynlig innehållsstämpel som visar var de kommer ifrån (standarden C2PA / \"Content Credentials\"). Det är lovande men långt ifrån vattentätt — stämplar kan tas bort.<br><br>Och se samtidigt skönheten i det AI skapar. I Långbans gruvby såg jag fotomontage som såg helt AI-genererade ut — de var det inte, de var Larseric Vänerlöfs konst. Vi är lite vilsna och söker äkthet, samtidigt som andra tar det äkta och får det att se fejkat ut.</div>\n</div>",
      "begrepp": [
        "deepfake",
        "källkritik",
        "verifiera",
    ...
    },
    {
      ...
      "fordjupning": "<p class=\"ingress\">Vi pratar mycket om att lita på maskiner. Men den obekväma spegelvändningen är minst lika intressant: kan man alltid lita på människor? I en maskin kan man mäta och delvis träna bort skevheten. Hos oss själva sitter den ofta fast — försvarad av prestige.</p>\n\n<div class=\"section\">\n  <div class=\"section-head\"><span class=\"num\">1</span><span class=\"concept\">Vi lär oss bäst tillsammans</span><span class=\"tag\">Folkbildning</span></div>\n  <div class=\"body\">Ny teknik lärs bäst i sällskap. När många delar sina misstag och genombrott samtidigt går inlärningen fort — samma nätverkseffekt som tekniken själv bygger på. Det sociala sammanhanget avgör om kunskapen fastnar.</div>\n</div>\n\n<div class=\"section\">\n  <div class=\"section-head\"><span class=\"num\">2</span><span class=\"concept\">Skillnaden mot människan</span><span class=\"tag\">Prestige och bias</span></div>\n  <div class=\"body\">En AI-modell har ingen prestige att försvara. Pekar du på en skevhet kan den mätas och delvis justeras. En människa som får sin fördom påpekad försvarar den ofta istället.<br><br>Det gör inte maskinen till en bättre människa — men det gör dess fel <em>lättare att komma åt</em>. Och det borde få oss att fundera: hur ofta granskar vi våra egna mönster lika hårt som vi granskar maskinens?</div>\n  <div class=\"insight\"><div class=\"insight-label\">En ärlig fundering</div><div class=\"insight-text\">AI-modellerna tränas att hjälpa och skydda varandra och oss. Vi människor borde också bli bättre på att skydda varandra. Samhället har blivit väldigt egocentrerat — och jag har aldrig så ofta som nu frågat mig vad som är mänskligt och värt att bevara.</div></div>\n</div>\n\n<div class=\"section\">\n  <div class=\"section-head\"><span class=\"num\">3</span><span class=\"concept\">När röster blockeras</span><span class=\"tag\">Vem får synas</span></div>\n  <div class=\"body\">Det finns en tyst kostnad i att stänga ute människor. När någon blockeras försvinner deras röst inte bara ur samtalet — den försvinner också ur den data som framtidens AI tränas på. Den som aldrig får synas blir osynlig även för maskinen.<br><br>Fast där finns också en poäng: nu kan vi göra kunskap även av själva blockaden. Det tystade kan bli en lärdom, om vi vågar se den.</div>\n</div>",
      "sektion": "020",
