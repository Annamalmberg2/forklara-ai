...
window.LECTURE = {
  ...
  "kort": [
    ...
    },
    {
      ...
      "fordjupning": "Kartan att ha i huvudet:\n\nNågra stora stängda modeller (Claude, ChatGPT, Gemini),\n\nEn snabbt växande öppen värld (Llama, Mistral, Qwen, DeepSeek) och miljontals specialiserade varianter på Hugging Face.\n\nFör dig som användare:\n\nDu är befälhavaren. Olika modeller för olika uppdrag, en modell för skrivande, en för kod och en liten lokal modell för känslig data.\n\nAtt välja rätt modell blir en vardagskompetens, som att välja verktyg ur lådan.\n\nIngen frågar om en spik sattes med hammare eller maskin, och ingen kallar spikpistolen fusk. Så ser jag på AI: jag visar fördelarna och potentialen, bemöter oro och missförstånd, och öppnar ögonen även på de mest skeptiska 'gamla rävarna'.\n\nGränserna suddas ut. Idag finns data i en bild som kan avslöja att den är AI-genererad — men det sitter redan AI i kameran när ett vanligt foto tas. Det blir svårare att dra gränsen den dag min robot målar konstverk i olja.",
