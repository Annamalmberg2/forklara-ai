...
window.LECTURE = {
  ...
  "kort": [
    ...
    },
    {
      ...
      "sektion": "080",
      "titel": "Bokföringen – verkligheten på besök",
      "begrepp": [
        "bokföring",
        "vardagsnytta"
      ],
  ...
  "stigar": [
    {
      "id": "teknisk",
      "namn": "Tekniska stigen",
      "beskrivning": "Under huven — tokens, nätverk och hårdvara"
    },
    {
      "id": "historisk",
      "namn": "Historiska stigen",
      "beskrivning": "Från Sokrates och Ada till spelen och genombrotten"
    },
    {
      "id": "filosofisk",
      "namn": "Filosofiska stigen",
      "beskrivning": "Konsten, etiken och de stora frågorna"
    },
    {
      "id": "komigang",
      "namn": "Kom igång-stigen",
      "beskrivning": "Verktygen, exemplen och dina första steg"
    }
  ]
};
