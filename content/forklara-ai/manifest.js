// ============================================================
// FÖRKLARA AI — innehållsfil (sparad från redigeringsläget 2026-07-31 23:51:36)
...
window.LECTURE = {
  ...
  "kort": [
    ...
    },
    {
      ...
      "fordjupning": "<p class=\"ingress\">Vår intuition är linjär — få kan tänka exponentiellt. Det är därför både pandemier och teknikskiften överraskar oss. Och det är därför den AI du har idag är den sämsta du någonsin kommer att ha.</p>\n\n<div class=\"section\">\n  <div class=\"section-head\"><span class=\"num\">1</span><span class=\"concept\">30 steg till månen</span><span class=\"tag\">Exponentiellt</span></div>\n  <div class=\"body\">30 linjära steg à en meter är 30 meter. 30 <em>exponentiella</em> steg, med fördubbling, är 2³⁰ − 1 meter ≈ <strong>1,07 miljarder meter</strong> — över en miljon kilometer. Månen ligger på 384 000 km. Du är långt förbi.<br><br>Klassikern att bjuda på: schackbrädet och riskornen. Ett korn på första rutan, dubbelt på nästa. Vid ruta 64 behövs mer ris än världen producerar.</div>\n</div>\n\n<div class=\"section\">\n  <div class=\"section-head\"><span class=\"num\">2</span><span class=\"concept\">Varför det fortsätter accelerera</span><span class=\"tag\">Skalningslagar</span></div>\n  <div class=\"body\">Det här är inte magi utan mätbart. Forskningen har hittat <strong>skalningslagar</strong>: ger man en modell mer data, mer beräkningskraft och fler parametrar blir den förutsägbart bättre. (OpenAI 2020, DeepMinds Chinchilla 2022.)<br><br>Samtidigt fördubblas hårdvarans kapacitet ungefär vartannat år (Moores lag har hållit i decennier). Två exponentialer som förstärker varandra — det är motorn bakom tempot.</div>\n  <div class=\"why\"><div class=\"why-label\">Var forskarna är oense</div><div class=\"why-text\">Skalningslagarna är robusta hittills — men ingen vet hur länge. En del menar att vi börjar ta slut på ny kvalitetsdata att träna på, andra att nya arkitekturer och mer beräkning bär vidare länge än. <strong>Att kurvan pekar brant uppåt är belagt. Att den fortsätter för evigt är det inte.</strong></div></div>\n</div>\n\n<div class=\"section\">\n  <div class=\"section-head\"><span class=\"num\">3</span><span class=\"concept\">Bortom inflektionspunkten</span><span class=\"tag\">Händelsehorisonten</span></div>\n  <div class=\"body\">Man pratar om en <em>inflektionspunkt</em> — där tekniken går från linjär till exponentiell i vår upplevelse, och där AI-agenter tar över mer avancerade uppgifter och skapar nya marknader.<br><br>Det går nästan inte att förutse vad som händer bortom den, ungefär som att inte kunna se innanför händelsehorisonten vid ett svart hål. Allt färre vågar ge en prognos ens ett år framåt.</div>\n  <div class=\"insight\"><div class=\"insight-label\">Ta med dig detta</div><div class=\"insight-text\">Den AI du har idag är den sämsta du någonsin kommer att ha. Den blir bättre — i allt snabbare takt.</div></div>\n</div>",
