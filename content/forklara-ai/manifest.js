// ============================================================
// FÖRKLARA AI — innehållsfil (sparad från redigeringsläget 2026-08-02 16:51:34)
...
window.LECTURE = {
  ...
  "kort": [
    ...
    },
    {
      ...
      "anteckningar": "Fredagslåtarna gör Martin Lönnstam och han gör dom riktigt bra med hjälp av Suno.\n\nMartin baserar dom på det jag lägger ut under en vecka\n\nIdén, orden, känslan, valet — hans. Själva musiken: ett AI-verktyg (Suno-liknande).\nPrecis vår röda tråd: maskinen gör mönster, människan gör mening.\n'Själv' betyder inte längre 'för hand' — det betyder 'med min avsikt'.\nMartin betalar för verktyget. Han äger valen.",
      "lankar": [
        [
          "Musiksidan",
          "https://sites.google.com/ainnova.se/aisverige/musik"
      ...
      "svar": "Nej — fredagslåtarna gör Martin Lönnstam och han gör dom riktigt bra med hjälp av Suno.",
      "fordjupning": "<p class=\"ingress\">\"Gör du fredagslåtarna själv?\" Det är en ärligare fråga än den låter — och den träffar precis mitt i det vi pratat om hela föreläsningen. Svaret är både ja och nej, och gränsen däremellan är det intressanta.</p>\n\n<div class=\"section\">\n  <div class=\"section-head\"><span class=\"num\">1</span><span class=\"concept\">Vad som är mitt</span><span class=\"tag\">Meningen</span></div>\n  <div class=\"body\">Idén, orden, känslan, vad låten ska säga och till vem — det styr Martin Lönnstam. Han väljer och styr utifrån det jag lagt ut under en vecka. Jag kan kassera om något inte stämmer men Martin och jag blir allt mer samspelta. Låten börjar och slutar hos mig men det är Martin som är dirigenten. </div>\n</div>\n\n<div class=\"section\">\n  <div class=\"section-head\"><span class=\"num\">2</span><span class=\"concept\">Vad maskinen gör</span><span class=\"tag\">Mönstret</span></div>\n  <div class=\"body\">Själva musiken — melodin, arrangemanget, rösten — skapar Martin med ett AI-verktyg, Syno. Han beskriver, det genererar, han lyssnar, väljer och styr om. Maskinen gör mönster; jag gör mening. Precis den röda tråden i hela den här föreläsningen, fast den här gången i toner.</div>\n  <div class=\"lost\"><div class=\"lost-label\">Här brukar folk tappa det</div><div class=\"lost-text\">\"Då är det väl inte din låt?\" Jo. Fotografen gör inte ljuset heller, men bilden är hens. Verktyget är nytt — men upphovet, valet och känslan är Martins och han har tagit bollen att skriva fredagslåtar av mitt material. Han kan garanterat skriva låtar på ditt material också.</div></div>\n</div>\n\n<div class=\"section\">\n  <div class=\"section-head\"><span class=\"num\">3</span><span class=\"concept\">Vad \"själv\" betyder nu</span><span class=\"tag\">Frågan</span></div>\n  <div class=\"body\">Förr betydde \"göra själv\" att göra för hand. Nu betyder det att göra med sin avsikt. Martin spelar inte varje ton — men varje låt bär hans val, hans känsla, mitt kanske mitt varför.</div>\n  <div class=\"insight\"><div class=\"insight-label\">Den viktiga insikten</div><div class=\"insight-text\">Framtidens hantverk är inte att göra allt för hand. Det är att veta exakt vad du vill säga — och ha smaken att välja rätt när maskinen ger dig tusen förslag.</div></div>\n</div>\n\n<hr>\n<div class=\"extra-head\">Begrepp i rockärmen</div>\n<div class=\"extra-grid\">\n  <div><div class=\"extra-name\">AI-musik</div><div class=\"extra-desc\">Musik genererad av en modell utifrån det du beskriver.</div></div>\n  <div><div class=\"extra-name\">Suno</div><div class=\"extra-desc\">Ett av verktygen som gör musik från en textbeskrivning.</div></div>\n  <div><div class=\"extra-name\">Upphovsmannaskap</div><div class=\"extra-desc\">Vem verket tillhör. Här: den som väljer och menar — inte verktyget.</div></div>\n  <div><div class=\"extra-name\">Kurering</div><div class=\"extra-desc\">Att välja bland många förslag. Blir kärnan i skapande med AI.</div></div>\n  <div><div class=\"extra-name\">Mönster vs mening</div><div class=\"extra-desc\">Maskinen gör mönstret, du gör meningen. Låtens själva hjärta.</div></div>\n  <div><div class=\"extra-name\">Smak som hantverk</div><div class=\"extra-desc\">Att veta vad som är rätt. Den förmåga som blir mest värd.</div></div>\n</div>\n<div class=\"future-box\">\n  <div class=\"future-head\">Något att bära med sig</div>\n  <div class=\"future-body\">Vi går mot en tid då vem som helst kan göra en låt på minuter. Då blir inte tekniken det som skiljer — utan smaken, avsikten, det du har att säga.<br><br>Fredagslåtarna har börjat bli en riktig skatt. Martin gör låten, masinen står för mönstret, och själv står jag för temat. Varje fredag.</div>\n</div>"
    },
    {
