...
window.LECTURE = {
  ...
  "kort": [
    ...
    },
    {
      ...
      "svar": "När jag som barn såg Hedvig prata i videotelefon så tänkte jag att det nog är långt in i framtiden. Idag känns det som framtiden ändras från vecka till vecka p g a AI",
      "bilder": [
        "Hedvig behövs.jpg"
      ],
      ...
      "anteckningar": "Jag har haft många bra lärare genom mitt liv och många betydande personer, idag lär jag mig mest av maskin. \n\nNär jag som barn såg Hedvig prata i videotelefon så tänkte jag att det nog är långt in i framtiden. Vad fel jag hade.\n\n1975 satt jag som barn på golvet och försökte förstå vuxna med hjälp av Hedvig lärde jag mig mycket. \n\n2026 är vi många som sitter och försöker förstå den nya tekniken som går under samlingsnamnet AI.\n\nFrån A till Ö var mitt första sci-fi-äventyr: videosamtal med mor, inte låta sig luras av svåra ord.\n\nVi behövde Hedvig då. Idag är det jag som får förklara. Jag ska hålla ihop det här AI-snacket lika pedagogiskt som hon och ugglan.\n\nDet finns egentligen bara en sak du behöver göra: sluta tveka, börja peta på tekniken, och gör det till en vana.\n\nNågra principer att hålla i handen på vägen:\n\n1. Gör det till en vana att fråga – om allt\n\nDet enda som faktiskt stoppar folk idag är den gamla vanan att försöka lösa allt själv i sitt eget huvud. Testa att bjud in AI:n i vardagen, inte bara när du har \"en AI-uppgift\". Mejl, planering, research, tankesparring eller bara när du fastnat. Det handlar inte om att automatisera livet, utan om att skaffa sig en ständig samtalspartner.\n\n2. Du är dirigenten\n\nLåt tekniken ge förslag, men det är du som fattar besluten. AI är en briljant underordnad som skickar ut utkast, men du bär ansvaret och håller i pennan. Läs alltid igenom, tänka själv och tyck till innan du skickar svaret vidare. Du är människan i loopen.\n\n3. Prata som folk med AI men lita inte blint på alla svar\n\nBehandla tekniken som en ny, väldigt påläst kollega. Prata med vanlig ton, ge kontext och förklara vad du vill uppnå. Men glöm aldrig vad den faktiskt är: en mönstermotor under huven. AI låter ofta bergfast säker på sin sak även när den cyklar helt ute i ogjort väder. Faktagranska som en kritisk journalist.\n\n4. Dagens AI är den sämsta du någonsin kommer möta\n\nDen teknik du har framför dig på skärmen idag är den absolut simplaste varianten du någonsin kommer att arbeta med framåt. \n\nDet du lär dig förstå om principerna, mönstren och resonemangen nu blir bara mer värt för varje vecka som går. Så vänta inte på att \"tekniken ska bli färdig\" \n\nTuta och kör från där tekniken är idag.",
      "personer": [
        "Hedvig"
      ],
      "begrepp": [
    ...
    },
    {
      "id": "030-nyms8rcr5c",
      "sektion": "030",
      "titel": "Blir det inte parodoxalt komlext?",
