...
window.LECTURE = {
  ...
  "kort": [
    ...
    {
      "id": "010-05",
      "fordjupning": "<p class=\"ingress\">AI känns som något splitternytt. Men drömmen — att tänkandet kan fångas i regler och utföras av något utanför en mänsklig hjärna — är ungefär 2400 år gammal. Den börjar med en grek som ställde en till synes enkel fråga: vad gör ett argument giltigt?</p>\n\n<div class=\"section\">\n  <div class=\"section-head\"><span class=\"num\">1</span><span class=\"concept\">Logiken Aristoteles fann</span><span class=\"tag\">Syllogismen</span></div>\n  <div class=\"body\">Aristoteles (~350 f.Kr.) var först med att <strong>formalisera</strong> hur vi drar korrekta slutsatser. Hans syllogism: om alla A är B, och alla B är C, så är alla A också C. Det gäller <em>oavsett</em> vad A, B och C står för.<br><br>Det var en revolutionerande idé: att sanning kan följa <strong>regler</strong> som är oberoende av innehållet. Giltigheten sitter i formen, inte i orden.</div>\n</div>\n\n<div class=\"section\">\n  <div class=\"section-head\"><span class=\"num\">2</span><span class=\"concept\">Vad \"first principles\" betyder</span><span class=\"tag\">Grunden</span></div>\n  <div class=\"body\">Aristoteles talade också om att tänka från <strong>första principer</strong> — att skala bort antaganden och analogier tills man står vid de grundläggande sanningar allt annat vilar på, och bygga upp därifrån.<br><br>Det är motsatsen till \"så har vi alltid gjort\". Och det är precis så man måste tänka för att förstå något så nytt som AI — inte \"vad liknar det?\", utan \"vad <em>är</em> det, i grunden?\".</div>\n</div>\n\n<div class=\"section\">\n  <div class=\"section-head\"><span class=\"num\">3</span><span class=\"concept\">Från regel till maskin</span><span class=\"tag\">Den långa tråden</span></div>\n  <div class=\"body\">Om tänkandet följer regler — kan då inte en maskin följa samma regler? Den frågan bär rakt genom historien:<br><br><strong>Leibniz</strong> (1600-talet) drömde om en \"tankekalkyl\" där man kunde <em>räkna</em> sig fram till sanning. <strong>George Boole</strong> (1854) gjorde logiken till algebra — sant och falskt som ettor och nollor. <strong>Turing</strong> (1936) byggde den teoretiska maskin som kunde utföra vilken sådan beräkning som helst. Och där, till slut, står datorn — och AI.</div>\n  <div class=\"insight\"><div class=\"insight-label\">Den viktiga insikten</div><div class=\"insight-text\">AI föddes inte i ett garage i Kalifornien. Den föddes när en grek frågade vad som gör ett argument giltigt — och tvåtusen år av tänkare svarade, ett steg i taget. Du står i slutet av en mycket lång tråd.</div></div>\n</div>\n\n<hr>\n<div class=\"extra-head\">Begrepp i rockärmen</div>\n<div class=\"extra-grid\">\n  <div><div class=\"extra-name\">Syllogism</div><div class=\"extra-desc\">Aristoteles regel för giltig slutledning. Sanning som följer formen, inte innehållet.</div></div>\n  <div><div class=\"extra-name\">Formell logik</div><div class=\"extra-desc\">Att tänka enligt regler som kan skrivas ner — och en dag utföras av en maskin.</div></div>\n  <div><div class=\"extra-name\">First principles</div><div class=\"extra-desc\">Att tänka från grunden i stället för från antaganden. Nyckeln till att förstå det nya.</div></div>\n  <div><div class=\"extra-name\">Leibniz</div><div class=\"extra-desc\">Drömde på 1600-talet om att räkna sig fram till sanning — en tankekalkyl.</div></div>\n  <div><div class=\"extra-name\">Boole</div><div class=\"extra-desc\">Gjorde logiken till algebra 1854. Sant och falskt blev ettor och nollor — datorns språk.</div></div>\n  <div><div class=\"extra-name\">Deduktion</div><div class=\"extra-desc\">Att härleda en säker slutsats ur givna premisser. Aristoteles gåva till oss alla.</div></div>\n</div>\n<div class=\"future-box\">\n  <div class=\"future-head\">Varför roten spelar roll</div>\n  <div class=\"future-body\">Länge trodde man att <em>all</em> intelligens kunde fångas i regler — bygg tillräckligt många \"om detta, så detta\", så tänker maskinen. Det var den drömmen som styrde AI i decennier (och som Deep Blue var höjdpunkten av).<br><br>Att den drömmen inte räckte — att verkligheten är för stor för att handkoda — är själva vändpunkten i min föreläsning. Men allt började här, med Aristoteles och tanken att tänkandet kan följa regler.</div>\n</div>",
      "sektion": "010",
      ...
      "anteckningar": "Drömmen om att mekanisera tänkandet är ~2400 år gammal.\nAristoteles formaliserade logiken: giltiga slutledningar följer regler, oavsett innehåll.\nFirst principles = tänka från grunden, inte från antaganden.\nTråden: Aristoteles → Leibniz → Boole → Turing → maskinen.\nAI började inte i Silicon Valley — den började med en fråga om vad ett giltigt argument är.",
      "bilder": [
    ...
    },
    {
      ...
      "anteckningar": "Jag följer många insatta inom AI och i biblioteket finns mycket som du kan ha nytta av.\n\nDet finns också extra info, extra länkar på de olika berättelsekorten precis som detta. Ser du något du gillar så kan du alltid fördjupa dig genom att fälla ut innehållet med pilen nedan.",
