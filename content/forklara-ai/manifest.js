// ============================================================
// FÖRKLARA AI — innehållsfil (sparad från redigeringsläget 2026-07-28 19:48:50)
...
window.LECTURE = {
  ...
  "kort": [
    ...
    },
    {
      ...
      "svar": "Svaret är varken maskinens eller teknikens, det är vårt. Maskinen besitter en oändlig kapacitet att lära ut, förklara om och anpassa sig på ett sätt som ingen mänsklig lärare, oavsett hur skicklig hon är.",
      "relaterat": [
        "020-10",
        "030-50"
      ],
      "anteckningar": "Det här är frågan hela föreläsningen hänger på men den har inget färdigt svar.\n\nAI kan bli en krycka som gör oss lata, eller ett bryne som tvingar fram skarpare frågor.\n\nSkillnaden är inte tekniken. Det är hur vi väljer att använda den.\nMaskinen gör mönster. Vi gör mening. Det är det viktigaste jag vill att ni bär med er härifrån.",
