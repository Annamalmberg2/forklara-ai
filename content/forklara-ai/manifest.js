// ============================================================
// FÖRKLARA AI — innehållsfil (sparad från redigeringsläget 2026-08-01 11:06:30)
...
window.LECTURE = {
  ...
  "kort": [
    ...
    },
    {
      ...
      "anteckningar": "Tekniken som bygger webbappar av en mening kallas ('vibe coding' - Karpathys ord).\n\nAllt ni sett ikväll kan ni börja bygga själva. Ikväll!\n\nGår ni via min affiliatelänk uppe till höger i OnBoarding appen så får ni extra gratispoäng så att ni faktiskt kan bygga något på riktigt.\n\nJag glömmer aldrig när jag bara skulle ställa en fråga till en AI men råkade skriva frågan i min byggar AI och den satte igång att bygga en DNS förflyttare.\n\nKastar du en pinne till en AI kastar den sig iväg som en glad apporterande labrador. I den apporten vet jag aldrig riktigt vad AI kommer att överraska mig med.\n\nDet är skillnad när jag jobbar med en sak som bokföring. Då jobbar AI bara i min mapp för ekonomi. Lika ivrigt som när AI apporterar fritt älskar den att skapa system i det område den tilldelats.",
      "personer": [
        "Andrej Karpathy",
        "Mauri"
      ],
