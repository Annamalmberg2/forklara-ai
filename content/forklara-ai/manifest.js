...
window.LECTURE = {
  ...
  kort: [
    ...
    {
      id: "000-50",
      fordjupning: "Ny teknik lärs bäst i sällskap. När många delar misstag och genombrott samtidigt går inlärningen fort — samma nätverkseffekt som tekniken själv bygger på.\n\nVuxna lär sig ny teknik bäst tillsammans; det sociala sammanhanget avgör om den fastnar. Fråga gärna publiken: vem är din AI-kompis?", sektion: "000", titel: "Logik är universell – AI Sverige",
    ...
    {
      id: "010-20",
      fordjupning: "Kartläsarens jobb är inte att minnas vägen — det är att läsa rätt karta i rätt ögonblick. När terrängen ritas om blir gamla meriter en risk: man svänger självsäkert åt fel håll.\n\nÖversatt till arbetslivet: erfarenhet är fortfarande guld, men som förmåga att navigera — inte som memorerad väg. Fråga inte 'vad kan jag?' utan 'hur uppdaterar jag min karta?'.", sektion: "010", titel: "Rallyt – gamla kartan gäller ej",
    ...
    {
      id: "010-30",
      fordjupning: "Sjökort uppdateras ständigt — grund flyttar sig, farleder muddras om. En kapten som seglar på förra årets kort är inte erfaren, bara farlig.\n\nSamma sak med AI: det som var sant om verktygen i fjol (priser, förmågor, begränsningar) är ofta fel i år. Kolla datumet på din kunskap.", sektion: "010", titel: "Kaptenen till sjöss",
    ...
    {
      id: "020-10",
      fordjupning: "I Platons dialog Faidros varnar Sokrates för skriften: den ger 'sken av visdom' och försvagar minnet. Han fick delvis rätt — vi minns sämre utantill — och ändå fel: skriften byggde vetenskapen.\n\nSamma mönster vid varje skifte: tryckpressen skulle dränka världen i dåliga böcker (det gjorde den — och i oumbärliga), internet skulle göra oss ytliga. Varje gång förlorade vi något och vann mer. Frågan är aldrig 'är den nya tekniken farlig?' utan 'vad väljer vi att bevara medvetet?'.", djup: 1, sektion: "020", titel: "Kunskapens fyra epoker",
    ...
    {
      id: "020-20",
      fordjupning: "First principles: skala bort allt du antagit och bygg från det som bevisligen är sant. Aristoteles gjorde det med naturen; dagens ingenjörer gör det med raketer och batterier.\n\nPå AI: i stället för att fråga 'vad säger folk om ChatGPT?' — fråga 'vad ÄR det här i grunden?'. Svaret (en funktion som gissar nästa ord, tränad på enorma mängder text) förklarar både styrkorna och misstagen bättre än all hajp.", sektion: "020", titel: "Aristoteles – first principles",
    ...
    {
      id: "030-20",
      fordjupning: "Deep Blue räknade omkring 200 miljoner ställningar i sekunden — rå styrka och handbyggda schackregler, ingen 'förståelse'. Kasparov vann mötet 1996; returmatchen 1997 slutade 3,5–2,5 till maskinen.\n\nIntressantast är Kasparovs slutsats efteråt: han blev förespråkare för 'centaur-schack' — människa och maskin som lag, vilket ofta slår båda var för sig. Det är fortfarande den bästa arbetsmodellen, långt utanför schacket.", djup: 1, sektion: "030", titel: "Deep Blue vs Kasparov 1997",
    ...
    {
      id: "040-10",
      fordjupning: "En bil gör vad ritningen säger. Ett neuralt nätverk 'ritas' inte — det tränas: miljarder små vikter justeras tills beteendet växer fram. Ingen, inte ens skaparna, kan peka på skruven där en viss kunskap sitter.\n\nDärför beter sig AI mer som något odlat än något byggt: förmågor dyker upp (och brister visar sig) på sätt som förvånar även forskarna. Och därför är testning — inte ritningsläsning — sättet att ta reda på vad en modell faktiskt kan.", sektion: "040", titel: "Inte en maskin i traditionell betydelse",
    ...
    {
      id: "040-30",
      fordjupning: "Kartan att ha i huvudet: några stora stängda modeller (Claude, GPT, Gemini), en snabbt växande öppen värld (Llama, Mistral, Qwen, DeepSeek) och miljontals specialiserade varianter på Hugging Face.\n\nFör dig som användare: du är befälhavaren. Olika soldater för olika uppdrag — en modell för skrivande, en för kod, en liten lokal modell för känslig data. Att välja rätt modell blir en vardagskompetens, som att välja verktyg ur lådan.", djup: 1, sektion: "040", titel: "Inte bara ett bolag – hela armén",
    ...
    {
      id: "050-10",
      fordjupning: "Den gamla AI:n (expertsystem) fick sina regler av oss: 'OM feber OCH utslag SÅ …'. Den kollapsade under verklighetens alla undantag. Maskininlärningen vände på steken: visa exempel och låt maskinen hitta reglerna själv.\n\nSpråkmodellerna tog sista steget: träna på ofattbara mängder text med en enda uppgift — gissa nästa ord. Det visade sig att den som gissar nästa ord riktigt, riktigt bra måste 'kunna' grammatik, fakta, logik och stil. Inte för att vi la in det — utan för att gissningen kräver det.", sektion: "050", titel: "Från regler till språk – maskinens resa",
    ...
    {
      id: "050-20",
      fordjupning: "Modellen läser inte ord utan tokens — bitar av ord. 'Föreläsning' kan bli tre bitar. Svenska kostar ofta fler tokens än engelska; därför kan modeller kännas lite 'dummare' på svenska.\n\nKontextfönstret är modellens arbetsminne: allt den ser just nu. Det som inte ryms finns inte för modellen — den 'minns' inte ert förra samtal om det inte skickas med igen. Många AI-besvikelser är egentligen kontextmissar: modellen fick aldrig se det du trodde den visste.", sektion: "050", titel: "Tokens, kontext och det svåraste jobbet",
    ...
    {
      id: "050-30",
      fordjupning: "Träningen: månader, tiotusentals grafikkort, kostnader i miljardklassen — en gång. Användningen: millisekunder och ören — miljarder gånger om dagen. Den ekonomin formar hela branschen.\n\nDärför NVIDIA: neurala nätverk är i grunden gigantisk matrismultiplikation, och grafikkort råkar vara byggda för exakt det. Spelindustrin subventionerade AI-revolutionens hårdvara i tjugo år utan att veta om det.", sektion: "050", titel: "Under huven – hårdvara och mjukvara",
    ...
    {
      id: "060-20",
      fordjupning: "En modell lär sig av det vi gjort — inklusive det vi borde sluta göra. Klassikern: rekryteringsverktyget som lärde sig av historiska anställningar och därför sorterade bort kvinnor. Mönstret var korrekt inlärt — och fel.\n\nBias syns sällan i ett enskilt svar; den syns i statistiken över tusen. Därför två frågor att alltid ställa: Vad tränades den på? Och vem finns inte i datan? En modell tränad mest på engelska ser världen genom engelska ögon.", sektion: "060", titel: "Bias – när mönstret lurar oss",
    ...
    {
      id: "070-10",
      fordjupning: "Bild-AI har 'sett' miljontals konstverk och lärt sig sambanden mellan ord och bild. Den lagrar inga kopior — men den bär stilarna. Att sätta in ett nytt ansikte i en klassiker tar sekunder.\n\nDet öppnar tre frågor på en gång: Vad är ett original? Var går gränsen mellan hyllning och stöld? Och kan någon äga en stil? Jurister och konstnärer sliter med alla tre. Publiken kan börja med den enklaste: blev det konst?", djup: 1, sektion: "070", titel: "Mona Lisa Anna",
    ...
    {
      id: "070-40",
      fordjupning: "Den här hänger i en ateljé på riktigt: olja, duk, veckor av arbete. Häng den bredvid AI-bilderna i samma kapitel och känn efter var skillnaden sitter — kanske inte i ytan, men i avsikten.\n\nMin arbetstes: AI:n kan härma uttryck men inte mena något. Konstnären väljer, ångrar, offrar. Om någon i publiken protesterar — utmärkt, då har vi ett samtal.", sektion: "070", titel: "Målningen – kvinnan lyfter mannen",
    ...
    {
      id: "070-50",
      fordjupning: "Ett enda suddigt foto räcker som utgångspunkt för en modern bildmodell — den 'vet' redan hur människor ser ut och fyller i resten. Det är verktygets styrka och dess varning i samma mening.\n\nVarningen konkret: samma teknik gör förfalskade bilder och röster till vardagsmat, och ett foto från sociala medier räcker. Rimlig husregel hemma: lita inte på bild eller röst som identitetsbevis — bestäm ett kodord i familjen redan idag.", sektion: "070", titel: "Mitt profilfoto som grund",
    ...
    {
      id: "070-70",
      fordjupning: "Fei-Fei Lis insikt var kontroversiell på sin tid: kollegorna jagade bättre algoritmer — hon byggde bättre data. 14 miljoner bilder, märkta för hand av tusentals människor.\n\n2012 vann AlexNet (Geoffrey Hintons studenter) tävlingen med djupinlärning på grafikkort och sänkte felprocenten dramatiskt. Tre ingredienser möttes: data (ImageNet), beräkningskraft (GPU:er) och algoritm (neurala nät). Ingen av dem var ny. Kombinationen förändrade allt.", djup: 3, sektion: "070", titel: "ImageNet & Fei-Fei Li",
    ...
    {
      id: "080-10",
      fordjupning: "Varför bokföring som testfall? För att den är obarmhärtig: siffrorna stämmer eller stämmer inte, och en revisor granskar resultatet. En perfekt miljö för att testa om AI håller i verkligheten — inte bara i demon.\n\nArbetsmodellen: AI:n gör grovjobbet (sortera, kontera, stämma av), människan äger besluten och ansvaret, och allt kontrolleras mot källorna. Mönster är vackra, bevis är sanning — även i ekonomin.", sektion: "080", titel: "Bokföring med AI",
    ...
    {
      id: "080-20",
      fordjupning: "Facit från revisorsbesöket: det AI-byggda höll. Men lärdomen är större än bokföringen. Det som avgjorde var arbetsdelningen — maskinen räknade, människorna granskade, ingen litade blint på någon.\n\nOch burgarna är också en poäng: om AI tar grovjobbet ska den frigjorda tiden bli mänsklig tid — samtal, skratt, kaffe. Annars gjorde vi fel på köpet.", djup: 1, sektion: "080", titel: "Verkligheten kom – vi firade med burgare",
    ...
    {
      id: "080-95",
      fordjupning: "'Vibe coding' — Andrej Karpathys ord för att bygga program genom att beskriva vad man vill ha, på vanligt språk. Tröskeln som föll var inte teknisk utan språklig: svenska blev ett programmeringsspråk.\n\nRealistisk förväntan: prototyper och personliga verktyg på en kväll. Riktiga produkter kräver fortfarande omsorg om säkerhet, data och underhåll. Men avståndet från idé till 'titta, den funkar!' har aldrig varit kortare.", sektion: "080", titel: "Lovable – bygg med en mening",
    ...
    {
      id: "100-10",
      fordjupning: "Tekniken i vänstra och högra bilden är samma teknik. Skillnaden är beställningen. AI optimerar det vi ber om — så den verkliga frågan är vad vi som samhälle beställer: övervakning eller folkbildning, rädsla eller folkvett.\n\nDärför är AI-politik ingen teknikfråga utan en värderingsfråga, och 'vi väljer' är bokstavligt: upphandlingar, lagar, skolplaner. Astrid-vägen kräver att vanligt folk förstår tekniken. Annars väljer någon annan åt oss.", djup: 1, sektion: "100", titel: "Strid eller Astrid",
    ...
    {
      id: "100-20",
      fordjupning: "Michael Endes 'Momo' kom 1973: de grå herrarna övertalar människor att 'spara tid' — och stjäl den. De sparade timmarna kommer aldrig tillbaka. Känns det igen? Varje effektivitetsteknik har lovat oss fritid och levererat högre tempo.\n\nAI blir det stora testet: om den gör din vecka fyra timmar snabbare — vart går timmarna? Om svaret är 'fler möten' har de grå herrarna vunnit igen. Momos superkraft var att lyssna på riktigt. Behåll den.", sektion: "100", titel: "Momo och de grå herrarna",
    ...
    {
      id: "110-10",
      fordjupning: "Skämtet har en udd: rädslan att ha fel är den dyraste känslan i en exponentiell tid. Den som måste ha rätt från början vågar aldrig testa.\n\nAI sänker priset på misstag dramatiskt — ett utkast kostar sekunder, en prototyp en kväll. Då blir modet att ha fel snabbt en konkurrensfördel. Felen är inte motsatsen till kunskap. De är råvaran.", djup: 1, sektion: "110", titel: "Nobelpriset i ekonomi 2026",
