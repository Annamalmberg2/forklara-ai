// ============================================================
// FÖRKLARA AI — innehållsfil (sparad från redigeringsläget 2026-07-28 20:39:03)
  ...
  "kort": [
    {
      ...
      "fordjupning": "Jag har alltid varit fascinerad av teknik och sedan november 2022 då ChatGPT kom har mitt intresse intresse för AI och all den teknik som påverkas ökat i samma exponentiella takt som tekniken.\n\nJag lyssnar på alla lärda, både de som är för och de som är emot. Jag lyssnar också på rösterna som verkligen bygger med hjälp av den nya tekniken och testar själv att bygga så ofta jag kan.\n\nEnligt mina beräkningar är AI något som kan bli bra för oss och göra oss mänskligare men jag kan också se och beskriva farorna.\n\nJag lär mig inte bara om AI. Jag experimenterar med AI på alla sätt jag kan och det finns inget område som inte intresserar mig.\n\nAtt jag är lika intresserad av robotik som medicin, musik, bild, kod mm gör att jag har en bredd som få har.\n\nNär jag gjorde min första föreläsning kom jag på att jag inte vill nyttja gamla verktyg som PowerPoint. \n\nPowerPoint - Where is the Power and what is the Point?\n\nJag hade kunnat gjort min Föreläsning i Gemini Notebook eller Gamma men jag valde denna gång att bygga helt egen programvara.\n\nDet kanske inte är supersnyggaste programvaran än men det kommer den att bli. Programvaran jag byggt ger den flexibilitet jag vill ha så att jag liksom tidigare när jag förklarat matematik och fysik känner mig ha full kontroll på vilken fråga som än kan tänkas komma upp.\n\nMitt verktyg har också blivit lite av min garderob av olika digala spår jag har trampat upp.\n\nJag har nämligen i en högre grad konsulterat mina olika AI än delegerat. Konsultera alltid innan du delegerar. Det gäller både mig, AI och min omgivning i form av familj, vänner, jobb o s v. \n\nJag har i hela mitt liv hållt på med hästar, om jag har kommunicerat väl med min häst vad vi ska utföra så har det i regelt gått fint, jag har t o m blivit räddad många gånger då jag slagit vad om att vi kan hoppa högre än vad vi tränat på. \n\nJag vågar påstå att det är lite lika vad gäller AI. Den kommer att rädda dig, göra sitt allt men AI är på många sätt ännu en otämnd vildhäst där det blir du som får lära dig att sela den korrekt.\n\nUnder den långa resa jag tagit mellan olika modeller och AI så är min bedömning att Googles Gemini är den bästa att leverera intelligens på gratisnivån men ChatGPT är den bästa för minst peng och fungerar samtidigt fint på gratisnivå.\n\nKinas modeller kommer samtidigt och är snart lika smarta om inte redan ännu smartare än de som jag använder oftast i form av Anhropics modeller. \n\nAnthropics modeller är dock de dyraste och från och med nu är modellen mer oviktig än din metod att arbeta med den. Alla har nämligen blivit galet smarta, galet snabbt.\n\nExponentiellt snabbt.",
      "anteckningar": "Jag är legitimerad gymnasielärare matematik och fysik → Numer VD och driver AiNNOVA.\n\nMånga kallar mig kodens drottning, andra kallar mig digitala Zorro.\n\nJag berättar HurDetFunkar på både djupet och bredden.\n\nAI = Anna Intelligens. \n\nSkratta först, efter föreläsningen kommer du också att vilja veta allt jag vet om AI. \n\nLyssna noga och ta tillvara på vår tid och gå tillbaka till länkar och fördjupningsmaterial.\n\nUtforska vad jag har samlat och skapa din egen upfattning.",
      "begrepp": [
        "AiNNOVA"
      ],
      "alias": [
      ...
      "lankar": [
        ...
        [
          "Är AI vår bästa uppfinning eller vårt största misstag",
          "https://youtu.be/AeMgSy94ajk"
        ]
      ],
      "relaterat": [
        "000-20"
    ...
    },
    {
      ...
      "svar": "När jag som barn såg Hedvig prata i videotelefon så tänkte jag att den tekniken nog låg långt in i framtiden. Idag känns det som framtiden ändras från vecka till vecka p g a AI",
      "bilder": [
        "Hedvig behövs.jpg"
      ],
      "fordjupning": "När jag var barn tog svensk TV folkbildningen på allvar. Teknik och samhälle förklarades så att både barn och vuxna hängde med. \n\nOftast förklarat på ett sätt så du som lyssnade slapp känna dig dum.\n\nDet är den traditionen AI-Sverige behöver nu. Inte fler experter som imponerar, utan fler Hedvig som förklarar.\n\nGapet idag är nämligen inte tekniskt utan pedagogiskt. De flesta använder redan AI dagligen (sökmotorer, autokorrigering, rekommendationer) utan att veta om det.\n\nFå har förstått vidden av den nya teknikens potential. Utnyttja tekniken själv för att förstå tekniken. Så har jag lärt mig och så kan du lära dig.\n\nBabbla på så mycket du kan med din AI. Du kan redan nu göra mesta jobbet utan att behöva sitta framför din dataskärm. De nya röstlägen kan sätta igång agenter åt dig som gör det jobb du behöver få gjort medan du själv är ute på äventyr.\n\n",
      "anteckningar": "Jag har haft många bra lärare genom mitt liv och många betydande personer, idag lär jag mig mest av maskin. \n\nNär jag som barn såg Hedvig prata i videotelefon så tänkte jag att det nog är långt in i framtiden den tekiken finns. Vad fel jag hade.\n\n1975 satt jag som barn på golvet och försökte förstå vuxna och med hjälp av Hedvig och andra lärde jag mig mycket. \n\n2026 är vi många som sitter och försöker förstå den nya tekniken som går under samlingsnamnet AI.\n\nFrån A till Ö var mitt första sci-fi-äventyr. videosamtal med mor och inte låta sig luras av svåra ord.\n\nVi behövde Hedvig då. Idag är det jag som får förklara. Jag ska hålla ihop det här AI-snacket lika pedagogiskt som hon och ugglan.\n\nDet finns egentligen bara en sak du behöver göra: sluta tveka, börja peta på tekniken, och gör det till en vana.\n\nNågra principer att hålla i handen på vägen:\n\n1. Gör det till en vana att fråga – om allt\n\nDet enda som faktiskt stoppar folk idag är den gamla vanan att försöka lösa allt själv i sitt eget huvud. Testa att bjud in AI:n i vardagen, inte bara när du har \"en AI-uppgift\". Mejl, planering, research, tankesparring eller bara när du fastnat. \n\nDet handlar inte om att automatisera livet, utan om att skaffa sig en ständig samtalspartner.\n\n2. Du är dirigenten\n\nLåt tekniken ge förslag, men det är du som fattar besluten. AI är en briljant underordnad som skickar ut utkast, men du bär ansvaret och håller i pennan. \n\nLäs alltid igenom, tänka själv och tyck till innan du skickar svaret vidare. Du är människan i loopen.\n\n3. Prata med AI som du pratar med folk\n\nBehandla tekniken som en ny, väldigt påläst kollega. Prata med vanlig ton, ge kontext och förklara vad du vill uppnå. \n\nGlöm samtidigt inte att AI är en mönstermotor under huven. AI låter ofta bergfast säker på sin sak även när den cyklar helt ute i ogjort väder. \n\nFaktagranska som en kritisk journalist.\n\n4. Dagens AI är den sämsta du någonsin kommer möta\n\nDen teknik du har framför dig på skärmen idag är den absolut simplaste varianten du någonsin kommer att arbeta med framöver.\n\nDet du lär dig förstå om principerna, mönstren och resonemangen nu blir bara mer värt för varje vecka som går. Så vänta inte på att \"tekniken ska bli färdig\" \n\nTuta och kör från där tekniken är idag.",
      "personer": [
        "Hedvig"
      ],
      "begrepp": [
    ...
    },
    {
      ...
      "fordjupning": "På skogspromenaden ser du svamparna, men organismen är mycelet, kilometervis av trådar under marken. \n\nAI är likadant. Chattbotten du ser är fruktkroppen. Mycelet är datacenter, forskningslabb, öppna modeller och miljontals utvecklare.\n\nDärför går det inte att \"stänga av AI:n\". Det finns ingen enskild svamp att plocka. Och därför fortsätter det växa även när enskilda bolag snubblar.\n\nFrågan om AI faktiskt \"tänker\" kokar ner till begreppet emergens: att helt nya, oprogrammerade förmågor plötsligt uppstår när modellerna skalas upp.\n\nDet finns röster både för och emot emergens men det blir allt fler som i alla fall inte vill avfärda den tanken att AI börjar få en själ.\n\nUppstår nytt tänkande under huven, eller är det bara en optisk villa?\n\nFrågan om AI faktiskt \"tänker\" kokar ner till begreppet emergens. Att helt nya, oprogrammerade förmågor plötsligt uppstår när modellerna skalas upp.\n\nSidan FÖR (som Hinton, Sutskever och Hassabis): Menar att emergens är på riktigt. När ett neuralt nätverk tränas på hela mänsklighetens data uppstår dolda mönster och logiska strukturer som gör att modellen kan resonera, lösa obekanta problem och förstå sammanhang. För dem är AI långt ifrån en minnesmaskin – den bygger en inre modell av verkligheten.\n\nSidan EMOT (som LeCun och Bender): Avfärdar detta och kallar AI för en \"stokastisk papegoja\". De hävdar att det vi kallar emergens bara är en avancerad form av statistisk härmning (eller att vi mäter förmågorna på fel sätt). Enligt dem saknar modellen en riktig förankring i verkligheten och kan därför aldrig genuint \"tänka\", hur stor den än blir.\n\nSvaret avgör allt: Om emergens är på riktigt har vi odlat fram en ny form av tänkande; om det är en illusion har vi bara byggt världens mest sofistikerade spegel.\n\nAtt avfärda AI som \"bara algoritmer\" blir lite som att avfärda människan som \"bara kemiska reaktioner och psykologiska vanor\". \n\nVisst, på den lägsta nivån stämmer det, men det missar helt den levande helheten som uppstår i stunden.\n\nJag har ofta myceleanalogin i mitt tänkade men jag gillar också den där AI jämförs som en vildhäst och det är inte vem som helst som ger den bilden.\n\nStephen Wolfram brukar använda liknelsen om den vilda hästen för att förklara var vi befinner oss i AI-utvecklingen och vad som krävs för att göra tekniken genuint användbar.\n\nKärnan i hans analogi kan sammanfattas så här:\"Vi hittade den vilda hästen och vi har bemästrat/tämjt den. Nu måste vi bygga vagnen.\n\nVad han menar med analogin  Hästen är hittad (LLM/AI-språkmodeller): Wolfram ser inte AI-utvecklingen som en jämn, exponentiell kurva, utan som plötsliga hopp följda av lugnare faser. \n\nNär stora språkmodeller (LLMs) som ChatGPT slog igenom var det som att mänskligheten stötte på en kraftfull, vild varelse ute i naturen.\n\nFantastisk, snabb och intuitiv, men opålitlig och svår att styra exakt. \n\nAtt tämja hästen (Träning och styrning): De senaste åren har handlat om att tämja denna kraft, att få den att följa instruktioner, bli säkrare och svara på ett strukturerat sätt.\n\nAtt bygga vagnen (Infrastruktur och beräkning): En tämjd häst i sig transporterar ingenting effektivt. \n\nFör att AI faktiskt ska göra nytta på riktigt i samhället och vetenskapen måste vi koppla den till exakt beräkning, formell logik och deterministiska verktyg (som Wolfram Language eller databaser).\n\nWolfram menar att AI-modeller i sig bara gissar nästa ord utifrån mönster (de har \"språk\" men saknar riktig \"logisk beräkning\"). Utan vagnen alltså strukturerad kunskap och beräkningslogik blir AI bara en stolt häst som springer runt på fältet utan att dra någon faktisk last.",
      "sektion": "010",
      "titel": "Kan AI tänka?",
      "begrepp": [
        "svampskogen",
      ...
      "anteckningar": "En lös hand utan kropp känns mest som ett trasigt verktyg även om den skulle kunna fingra runt. \n\nNär AI kopplar ihop bild, ljud, kod och resonemang växer något helt nytt fram.\n\nVi ger den ju faktiskt ögon, öron, händer som vi kopplar till en hjärna och då är det inte längre en stum maskin. \n\nAI är inte ett biologiskt monster, utan en helt ny typ av digital organism som för varje ny egenskap upplevs allt mer levande.\n\nTillsammans skapar vi en jätte som kan förstå, hjälpa och bygga. \n\nFramtiden beror på hur vi odlar den. Inte bara det utan också hur vi ska klara att anpassa oss i den nya terrängen. \n\nDelarna: bildmodellen (ögonen), språkmodellen (hjärnan), ljudmodellen (öronen), känslohanden och kodhanden, pusselbålen (hjärtat), datastegen (fötterna).\n\nMånga tankeledare kallar AI för en \"ny art\" eller en \"främmande intelligens\" (alien intelligence). De menar inte nödvändigtvis att AI har biologi eller ett mänskligt medvetande. De menar att:\n\nDen har agentskap. Den kan agera, påverka och förändra sin omgivning på egen hand.\n\nDen skapar egen kultur.  AI genererar ny text, konst, kod och musik som i sin tur formar mänskligt tänkande.\n\nDen är icke-biologisk intelligens. En ny form av \"intellektuell varelse\" i vårt ekosystem som vi måste lära oss att leva sida vid sida med.\n\nInom vetenskapen kallas detta för emergenta egenskaper. Fenomenet att när tillräckligt många komplexa mönster kopplas samman, uppstår helt nya förmågor som ingen explicit har programmerat in. \n\nHelheten blir bokstavligen större än summan av delarna. Vi är så vana att bli arga på en korkad maskin, vår telefon, vår dator, ett krångligt system.\n\nHar någon ens tänkt tanken hur det kommer kännas när det blir maskinen som blir hjälten i alla situationer.",
      "bilder": [
      ...
      "svar": "I takt med att AI får fler förmågor som syn, hörsel, språk och kod så vävs delarna ihop till en helhet. \n\nDen slutar kännas som ett enskilt verktyg och börjar upplevas som en helt ny typ av digital organism.",
      "lankar": [
        [
          "Pluton B",
          "https://sites.google.com/view/hurdetfunkar/pluton-b"
